...
automate-testing/
│
├── back/                     # Backend project and test resources
│   ├── pom.xml               # Maven build configuration for backend
│   ├── src/
│   │   ├── main/java/...     # Java source code for the application
│   │   └── test/java/...     # Java test code (JUnit / Cucumber)
│   ├── resources/            # Application resources (YAML configs, DB migrations)
│   ├── jmeter/               # JMeter test plans and data files
